...
<div class="well sidebar-nav">
    <ul class="nav nav-list">
        ...
        <li><a id="lnkLenguaje" href="jsp#/lenguaje">Lenguaje</a></li>
        ...
        <li><a id="lnkDocumento" href="jsp#/documento">Documento</a></li> 
        <li><a id="lnkTipodocumento" href="#">Tipodocumento</a></li>
        <li><a id="lnkActividad" href="jsp#/actividad">Actividad</a></li>
