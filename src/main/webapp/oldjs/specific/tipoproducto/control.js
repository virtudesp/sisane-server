...
tipoproductoControl.prototype.edit = function (place, id, oModel, oView) {
    var thisObject = this;
    $(place).empty();
    ...
    nombre = $('#nombre').val();
    nombre = nombre.replace("<a href=\"jsp#/tema/list/systemfilter=id_tipoproducto&systemfilteroperator=equals&systemfiltervalue=" + $('#id').val() + "\">","").replace("</a>","");
    $('#nombre').val(nombre);
