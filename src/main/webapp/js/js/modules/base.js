...
var baseOperation = function () {
    this.strPlace = undefined;

    this.errorStatus = undefined;
    this.errorMessage = undefined;
    
    this.gettingData = $.Deferred();    
...
baseOperation.prototype.notifyException = function () {
    this.strPlace.html("Error " + this.errorStatus + ": " + this.errorMessage);
}