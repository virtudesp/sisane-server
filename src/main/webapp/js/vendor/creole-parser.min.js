...
var creole = function(j) {
    ...
    var a = {_G: {_2: 'hr', _1: /(^|\n)\s*----\s*(\n|$)/}, _H: {_2: 'br', _1: /\\\\/}, _I: {_2: 'pre', _3: 2, _1: /(^|\n)\{\{\{\n((.*\n)*?)\}\}\}(\n|$)/, _f: /^ ([ \t]*\}\}\})/gm, _j: '$1'}, _J: {_2: 'tt', _1: /\{\{\{(.*?\}\}\}+)/, _3: 1, _f: /\}\}\}$/, _j: ''}, _k: {_2: 'ul', _3: 0, _1: /(^|\n)([ \t]*\*[^*#].*(\n|$)([ \t]*[^\s*#].*(\n|$))*([ \t]*[*#]{2}.*(\n|$))*)+/}, _l: {_2: 'ol', _3: 0, _1: /(^|\n)([ \t]*#[^*#].*(\n|$)([ \t]*[^\s*#].*(\n|$))*([ \t]*[*#]{2}.*(\n|$))*)+/}, _m: {_2: 'li', _3: 0, _1: /[ \t]*([*#]).+(\n[ \t]*[^*#\s].*)*(\n[ \t]*[*#]{2}.+)*/, _f: /(^|\n)[ \t]*[*#]/g, _j: '$1'}, _w: {_2: 'table', _3: 0, _1: /(^|\n)(\|.*?[ \t]*(\n|$))+/}, _x: {_2: 'tr', _3: 2, _1: /(^|\n)(\|.*?)\|?[ \t]*(\n|$)/}, _y: {_2: 'th', _1: /\|+=([^|]*)/, _3: 1}, _z: {_2: 'td', _3: 1, _1: '\\|+([^|~\\[{]*((~(.|(?=\\n)|$)|\\[\\[' + c._a + '(\\|' + c._d + ')?\\]\\]' + (j && j.strict ? '' : '|' + c._b) + '|[\\[{])[^|~]*)*)'}, _n: {_1: /.+/, _3: 0}, _A: {_2: 'p', _3: 0, _1: /(^|\n)([ \t]*\S.*(\n|$))+/}, _B: {_3: 0, _1: /(^|\n)([ \t]*[^\s].*(\n|$))+/}, _C: {_2: 'strong', _3: 1, _1: /\*\*([^*~]*((\*(?!\*)|~(.|(?=\n)|$))[^*~]*)*)(\*\*|\n|$)/}, _D: {_2: 'em', _3: 1, _1: '\\/\\/(((?!' + c._e + ')[^\\/~])*((' + c._7 + '|\\/(?!\\/)|~(.|(?=\\n)|$))((?!' + c._e + ')[^\\/~])*)*)(\\/\\/|\\n|$)'}, _b: {_1: c._b, _4: function(e, b, d) {
                ...
                e.appendChild(f)
            }}, _6: {_1: '\\[\\[(' + c._a + ')\\|(' + c._d + ')\\]\\]', _4: function(e, b, d) {
                var f = document.createElement('a');
                f.href = d && d.linkFormat ? k(b[1].replace(/~(.)/g, '$1'), d.linkFormat) : b[1].replace(/~(.)/g, '$1');
                this._5(f, b[2], d);
                e.appendChild(f)
            }}, _p: {_1: '\\[\\[(' + c._u + ')\\]\\]'}, _q: {_1: '\\[\\[(' + c._a + ')\\]\\]'}, _r: {_1: '\\[\\[(' + c._v + ')\\]\\]'}, _7: {_1: '(' + c._7 + ')'}, _K: {_1: '~(' + c._7 + '|.)', _3: 1, _2: 'span', _c: {'class': 'escaped'}}, _L: {_1: /~(.)/, _3: 1, _2: 'span', _c: {'class': 'escaped'}}};
    ...
    a._s = {_1: '\\[\\[(' + c._v + ')\\|(' + c._d + ')\\]\\]', _4: function(e, b, d) {
            var f = document.createElement('a');
            var g, h;
            if (d && d.interwiki) {
                g = b[1].match(/(.*?):(.*)/);
    ...
    a._t = {_0: [a.h1, a.h2, a.h3, a.h4, a.h5, a.h6, a._G, a._k, a._l, a._I, a._w], _8: {_0: [a._A]}};
...
creole._9.prototype = {_E: null, _g: null, _h: null, parse: function(e, b, d) {
        if (d) {
            for (i in this._h) {
...
creole._i.prototype = {_F: function(e, b) {
