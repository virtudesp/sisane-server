...
import net.daw.control.operation.specific.implementation.ProductoControlOperationSpcImpl;
import net.daw.control.process.publicinterface.ControlProcessInterface;

public class ProductoControlProcessSpecificImplementation implements ControlProcessInterface {

    @Override
    public String execute(HttpServletRequest request) throws Exception {
        String operation = request.getParameter("op");
        ProductoControlOperationSpcImpl oControlOperation = new ProductoControlOperationSpcImpl(request);
        String jsonResult = "";
        switch (operation) {
            case "get":
