...
import net.daw.control.operation.specific.implementation.TipoproductoControlOperationSpcImpl;
import net.daw.control.process.publicinterface.ControlProcessInterface;

public class TipoproductoControlProcessSpecificImplementation implements ControlProcessInterface {

    @Override
    public String execute(HttpServletRequest request) throws Exception {
        String operation = request.getParameter("op");
        TipoproductoControlOperationSpcImpl oControlOperation = new TipoproductoControlOperationSpcImpl(request);
        String jsonResult = "";
        switch (operation) {
            case "get":
