...
import net.daw.service.specific.implementation.TipoproductoServiceSpcImpl;

public class TipoproductoControlOperationSpcImpl implements ControlOperationInterface {

    private GenericConnectionInterface DataConnectionSource = null;
    private Connection oConnection = null;
    //private final String operation, object;
    private final TipoproductoServiceSpcImpl oTipoproductoService;

    public TipoproductoControlOperationSpcImpl(HttpServletRequest request) throws ClassNotFoundException, NoSuchMethodException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        DataConnectionSource = new BoneConnectionPoolImpl();
        oConnection = DataConnectionSource.newConnection();
        oTipoproductoService = new TipoproductoServiceSpcImpl("Tipoproducto", oConnection);
    }
