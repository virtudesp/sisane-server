...
import net.daw.service.specific.implementation.ProductoServiceSpcImpl;

public class ProductoControlOperationSpcImpl implements ControlOperationInterface {

    private GenericConnectionInterface DataConnectionSource = null;
    private Connection oConnection = null;
    //private final String operation, object;
    private final ProductoServiceSpcImpl oProductoService;

    public ProductoControlOperationSpcImpl(HttpServletRequest request) throws ClassNotFoundException, NoSuchMethodException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        DataConnectionSource = new BoneConnectionPoolImpl();
        oConnection = DataConnectionSource.newConnection();
        oProductoService = new ProductoServiceSpcImpl("Producto", oConnection);
    }
    ...
    public String getprettycolumns(HttpServletRequest request) throws Exception {
        String result = oProductoService.getPrettyColumns();
        closeDB();
        return result;
    }
    ...
    public String getcolumns(HttpServletRequest request) throws Exception {
        String result = oProductoService.getColumns();
        closeDB();
        return result;
    }
