...
public class UsuarioDaoImpl extends GenericTableDaoImpl<UsuarioBeanImpl> {

    public UsuarioDaoImpl(Connection pooledConnection) throws Exception {
        super("usuario", pooledConnection);
    }

    public UsuarioBeanImpl getFromLogin(UsuarioBeanImpl oUsuario) throws Exception {
        try {
