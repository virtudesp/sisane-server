...
public class PermisoDao extends TableDaoGenImpl<PermisoBean> {

    

    public PermisoDao(  Connection pooledConnection) throws Exception {
        super( pooledConnection);
       
    }

    public int getPermissionId(PermisoBean oPermisoBean) throws SQLException {
        int id = 0;
        try {
    ...
    public boolean hasPermission(PermisoBean oPermisoBean) throws SQLException {
