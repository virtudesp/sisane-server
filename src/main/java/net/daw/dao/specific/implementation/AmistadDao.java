...
public class AmistadDao extends TableDaoGenImpl<AmistadBean> {

    public AmistadDao(Connection pooledConnection) throws Exception {
    ...
    public AmistadBean removeAmigo(AmistadBean oAmigoBean) throws Exception {
        try {
    ...
    public Boolean existeAmigo(AmistadBean oAmigoBean) throws Exception {
        int oAmigo = 0;
        Boolean amigo = false;
        try {
