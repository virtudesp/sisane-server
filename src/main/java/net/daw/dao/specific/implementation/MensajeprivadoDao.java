...
import net.daw.bean.specific.implementation.MensajeprivadoBean;
...
public class MensajeprivadoDao implements ViewDaoInterface<MensajeprivadoBean>,TableDaoInterface<MensajeprivadoBean>, MetaDaoInterface {

    private String strTableName = null;
    private MysqlDataSpImpl oMysql = null;
    private Connection oConnection = null;

    public MensajeprivadoDao(String ob, Connection oConexion) throws Exception {
        try {
            strTableName = ob;
    ...
    public ArrayList<MetaBeanGenImpl> getmetainformation() throws Exception {
        ...
        try {
            ...
            for (Field field : MensajeprivadoBean.class.getDeclaredFields()) {
    ...
    @Override
    public ArrayList<MensajeprivadoBean> getPage(int intRegsPerPag, int intPage, ArrayList<FilterBeanHelper> hmFilter, HashMap<String, String> hmOrder) throws Exception {
        ArrayList<Integer> arrId;
        ArrayList<MensajeprivadoBean> arrMensajeprivado = new ArrayList<>();
        try {
            arrId = oMysql.getPage(strTableName, intRegsPerPag, intPage, hmFilter, hmOrder);
            Iterator<Integer> iterador = arrId.listIterator();
            while (iterador.hasNext()) {
                MensajeprivadoBean oMensajeprivadoBean = new MensajeprivadoBean(iterador.next());
    ...
    @Override
    public MensajeprivadoBean get(MensajeprivadoBean oMensajeprivadoBean, Integer expand) throws Exception {
            ...
            try {
                if (!oMysql.existsOne(strTableName, oMensajeprivadoBean.getId())) {
                    ...
                    if (expand > 0) {
                        ...
                        UsuarioDao oUsuarioDAO1 = new UsuarioDao(oConnection);
                        ...
                        UsuarioDao oUsuarioDAO2 = new UsuarioDao(oConnection);
    ...
    @Override
    public MensajeprivadoBean set(MensajeprivadoBean oMensajeprivadoBean) throws Exception {
        try {
            Boolean isNew = false;
    ...
    @Override
    public int remove(MensajeprivadoBean oMensajeprivadoBean) throws Exception {
        int result = 0;
        try {
