...
public class ProductoDaoSpcImpl implements ViewDaoInterface<ProductoBeanGenSpImpl>, TableDaoInterface<ProductoBeanGenSpImpl>, MetaDaoInterface {
    ...
    public ProductoDaoSpcImpl(String ob, String pojo, Connection oConexion) throws Exception {
        try {
            strTableName = ob;
            ...
            try {
                if (!oMysql.existsOne(strTableName, oProductoBean.getId())) {
                    ...
                    if (expand > 0) {
                        ...
                        TipoproductoDaoSpcImpl oTipoproductoDAO = new TipoproductoDaoSpcImpl("tipoproducto", "Tipoproducto",oConnection);
