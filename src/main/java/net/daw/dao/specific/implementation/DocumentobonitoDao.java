...
import net.daw.bean.specific.implementation.DocumentobonitoBean;

public class DocumentobonitoDao extends TableDaoGenImpl<DocumentobonitoBean> {

    public DocumentobonitoDao(Connection pooledConnection) throws Exception {
