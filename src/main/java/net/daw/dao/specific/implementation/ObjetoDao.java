...
public class ObjetoDao extends TableDaoGenImpl<ObjetoBean> {

 

    public ObjetoDao(  Connection pooledConnection) throws Exception {
    ...
    public int getId(ObjetoBean oObjeto) throws SQLException {
        int id = 0;
        try {
