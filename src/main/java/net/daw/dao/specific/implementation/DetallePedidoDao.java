...
import net.daw.bean.specific.implementation.DetallePedidoBean;
...
public class DetallePedidoDao implements ViewDaoInterface<DetallePedidoBean>, TableDaoInterface<DetallePedidoBean>, MetaDaoInterface {

    private String strTableName = null;
    private MysqlDataSpImpl oMysql = null;
    private Connection oConnection = null;

    public DetallePedidoDao(String ob, Connection oConexion) throws Exception {
        try {
            strTableName = ob;
    ...
    public ArrayList<MetaBeanGenImpl> getmetainformation() throws Exception {
        ...
        try {
            ...
            for (Field field : DetallePedidoBean.class.getDeclaredFields()) {
    ...
    @Override
    public ArrayList<DetallePedidoBean> getPage(int intRegsPerPag, int intPage, ArrayList<FilterBeanHelper> hmFilter, HashMap<String, String> hmOrder) throws Exception {
        ArrayList<Integer> arrId;
        ArrayList<DetallePedidoBean> arrDetallePedido = new ArrayList<>();
        try {
            arrId = oMysql.getPage(strTableName, intRegsPerPag, intPage, hmFilter, hmOrder);
            Iterator<Integer> iterador = arrId.listIterator();
            while (iterador.hasNext()) {
                DetallePedidoBean oDetallePedidoBean = new DetallePedidoBean(iterador.next());
