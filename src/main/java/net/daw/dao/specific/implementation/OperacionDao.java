...
public class OperacionDao extends TableDaoGenImpl<OperacionBean> {

    public OperacionDao(Connection pooledConnection) throws Exception {
        super(pooledConnection);

    }

    public int getOperationId(OperacionBean oOperacionBean) throws SQLException {
        int id = 0;
        try {
