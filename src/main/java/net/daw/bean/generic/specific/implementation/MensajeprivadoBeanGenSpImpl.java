 ...
 * @author a021008858z
 */
public class MensajeprivadoBeanGenSpImpl extends BeanGenImpl implements BeanInterface {
    ...
    public MensajeprivadoBeanGenSpImpl(){ 
        
    }
    public MensajeprivadoBeanGenSpImpl(int id){
        super(id);
    }
