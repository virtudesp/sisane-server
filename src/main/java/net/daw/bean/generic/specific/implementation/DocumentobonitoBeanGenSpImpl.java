...
public class DocumentobonitoBeanGenSpImpl extends BeanGenImpl implements BeanInterface {

    public DocumentobonitoBeanGenSpImpl() {
    }

    public DocumentobonitoBeanGenSpImpl(Integer id) {
        super(id);
    }
