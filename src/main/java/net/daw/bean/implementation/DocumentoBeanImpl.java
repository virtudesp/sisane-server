...
public class DocumentoBeanImpl extends GenericBeanImpl implements BeanInterface {

    public DocumentoBeanImpl() {
    }

    public DocumentoBeanImpl(Integer id) {
        super(id);
    }
    ...
    private UsuarioBeanImpl obj_usuario = null;
    @Expose(serialize = false)
    private Integer id_tipodocumento = 0; //importante inicializar a 0 las claves ajenas
    @Expose(deserialize = false)
    private TipodocumentoBeanImpl obj_tipodocumento = null;
    @Expose
...
//    }
    ...
    public UsuarioBeanImpl getObj_usuario() {
        return obj_usuario;
    }

    public void setObj_usuario(UsuarioBeanImpl obj_usuario) {
        this.obj_usuario = obj_usuario;
    }

    public TipodocumentoBeanImpl getObj_tipodocumento() {
        return obj_tipodocumento;
    }

    public void setObj_tipodocumento(TipodocumentoBeanImpl obj_tipodocumento) {
