...
public class TrabajoBean extends BeanGenImpl implements BeanInterface {
    ...
    private TipotareaBean obj_tipotarea = null;
    
    @Expose(serialize = false)
    private Integer id_estadotarea = 0; //importante inicializar a 0 las claves ajenas
    @Expose(deserialize = false)
    private EstadotareaBean obj_estadotarea = null;
    ...
    public TipotareaBean getObj_tipotarea() {
        return obj_tipotarea;
    }

    public void setObj_tipotarea(TipotareaBean obj_tipotarea) {
    ...
    public EstadotareaBean getObj_estadotarea() {
        return obj_estadotarea;
    }

    public void setObj_estadotarea(EstadotareaBean obj_estadotarea) {
