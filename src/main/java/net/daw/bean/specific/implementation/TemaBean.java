...
public class TemaBean extends BeanGenImpl implements BeanInterface {
    ...
    private TipotemaBean obj_tipotema = null;
    ...
    public TipotemaBean getObj_tipotema() {
        return obj_tipotema;
    }

    public void setObj_tipotema(TipotemaBean obj_tipotema) {
