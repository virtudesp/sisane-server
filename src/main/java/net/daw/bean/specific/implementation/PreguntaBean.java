...
public class PreguntaBean extends BeanGenImpl implements BeanInterface {
   ...
   @Expose
    ...
    private CuestionarioBean obj_cuestionario = null;
    ...
    public CuestionarioBean getObj_cuestionario() {
        return obj_cuestionario;
    }

    public void setObj_cuestionario(CuestionarioBean obj_cuestionario) {
