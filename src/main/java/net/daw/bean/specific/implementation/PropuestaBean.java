 ...
 * @author al037805
 */
public class PropuestaBean extends BeanGenImpl implements BeanInterface{
    ...
    private TipopropuestaBean obj_tipopropuesta = null;
    @Expose (serialize = false)
     ...
     */
    public TipopropuestaBean getObj_tipopropuesta() {
     ...
     */
    public void setObj_tipopropuesta(TipopropuestaBean obj_tipopropuesta) {
