...
public class GenericMetaServiceImpl implements MetaServiceInterface {
        protected Connection oConnection = null;
    protected String strObjectName = null;

    public GenericMetaServiceImpl(String ob, Connection con) {
    ...
    public String getPrettyColumns() throws Exception {
        try {
            ...
            GenericTableDaoImpl oDao = (GenericTableDaoImpl) c.newInstance(oConnection);
