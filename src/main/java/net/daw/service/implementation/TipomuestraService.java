 ...
 * @author a022595832b
 */
public class TipomuestraService implements TableServiceInterface, ViewServiceInterface{
    
    protected HttpServletRequest oRequest = null;

    public TipomuestraService(HttpServletRequest request) {
        oRequest = request;
    }
...
//        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
        ...
        if (this.checkpermission("get")) {
            ...
            try {
                ...
                data = JsonMessage.getJsonExpression(200, AppConfigurationHelper.getGson().toJson(oTipomuestraBean));
            } catch (Exception ex) {
        ...
        if (this.checkpermission("set")) {
            ...
            try {
                ...
                if (oTipomuestraBean != null) {
                    Integer iResult = oTipomuestraDao.set(oTipomuestraBean);
                    if (iResult >= 1) {
